...
class LibWebRtcPeer:
    ...
    by :func:`libwebrtc_peer_factory`, which negotiates the offer into an answer;
    the connection then registers its inbound callbacks and drives the peer for
    the rest of its life. Do not instantiate directly.
    """
    ...
    def __init__(self) -> None:
        ...
        logger.info("LibWebRtcPeer initialized")
...
) -> tuple[LibWebRtcPeer, SdpAnswer]:
    """Negotiate *offer* into a :class:`LibWebRtcPeer` and its SDP answer.
